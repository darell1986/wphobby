...
function essb_get_present_settings($position = '') {
	...
	$result ["{$position}_networks"] = array ("facebook", "twitter", "google", "pinterest", "buffer", "love", "share" );
	$result ["{$position}_nospace"] = "true";
	$result ["{$position}_share_button_icon"] = "share";
	$result ["{$position}_share_button_func"] = "2";
	$result ["{$position}_share_button_style"] = "button";
	$result ["{$position}_share_button_counter"] = "bottom";
