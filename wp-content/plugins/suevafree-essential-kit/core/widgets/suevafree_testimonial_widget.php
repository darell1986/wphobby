...
class suevafree_testimonial_widget extends WP_Widget {
	
	public function __construct() {
		
		parent::__construct( "suevafree_testimonial_widget", "SuevaFree Testimonial Slideshow", array("description" => "SuevaFree Testimonial Slideshow"));
	}
	...
	public function form( $instance ) {
		...
		$defaults = array( 
            ...
            'title_size' => '50px',
            'title_color' => '#ffffff',
			'description' => "Here's what our clients had to say.",
	...
	public function widget( $args, $instance ) {
		...
		<style scoped>
			...
			#<?php echo esc_attr($args['widget_id']); ?> .suevafree-testimonial-widget {
			...
			<?php if ( $instance['title_size']) : ?>
				...
				#<?php echo esc_attr($args['widget_id']); ?> .suevafree-testimonial-widget h4 {
			...
			<?php if ( $instance['description_size']) : ?>
				...
				#<?php echo esc_attr($args['widget_id']); ?> .suevafree-testimonial-widget .subtitle {
        ...
        <section class="suevafree-testimonial-widget">
                        ...
                        <div id="<?php echo esc_attr($args['widget_id']); ?>-carousel" class="slick-suevafree-slideshow" data-center="false" data-columns="<?php echo $instance['columns'];?>" >
                            ...
                            <?php
                                ...
                                while ( $query->have_posts() ) : $query->the_post(); 
                                    ...
                                    $thumb = wp_get_attachment_image_src( get_post_thumbnail_id(), 'sueva_testimonial');
                                            ...
                                            <div class="testimonial-details" >
                                                ...
                                                <div class="client">
                                                    ...
                                                    <div class="testimonial-info left">
                                                    	...
                                                    	<span class="testimonial-name"><?php echo esc_attr(get_the_title()); ?></span>
                                                    	<span class="testimonial-company"><?php echo esc_attr(suevafree_ek_postmeta('wip_testimonial_website'));?></span>
