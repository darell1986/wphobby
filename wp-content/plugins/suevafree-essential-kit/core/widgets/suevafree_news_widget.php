...
class suevafree_news_widget extends WP_Widget {
	
	public function __construct() {
		
		parent::__construct( "suevafree_news_widget", "SuevaFree News Slideshow", array("description" => "SuevaFree News Slideshow"));
	}
	...
	public function widget( $args, $instance ) {
		...
		<style scoped>
			...
			#<?php echo esc_attr($args['widget_id']); ?> .suevafree-news-widget {
			...
			<?php if ( $instance['title_size']) : ?>
				...
				#<?php echo esc_attr($args['widget_id']); ?> .suevafree-news-widget h4 {
			...
			<?php if ( $instance['description_size']) : ?>
				...
				#<?php echo esc_attr($args['widget_id']); ?> .suevafree-news-widget .subtitle {
        ...
        <section class="suevafree-news-widget">
                        ...
                        <div id="<?php echo esc_attr($args['widget_id']); ?>-carousel" class="slick-suevafree-slideshow" data-center="false" data-columns="<?php echo $instance['columns'];?>" >
                            ...
                            <?php
                                ...
                                while ( $query->have_posts() ) : $query->the_post(); 
                                    ...
                                    $thumb = wp_get_attachment_image_src( get_post_thumbnail_id(), 'sueva_blog_thumbnail');
                                    ...
                                    <div>
                                        ...
                                        <div class="news-item" >
                                            ...
                                            <div class="news-details" >
                                                ...
                                                <a href="<?php echo get_permalink($post->ID); ?>"><h5><?php echo esc_attr(get_the_title()); ?></h5></a>
                                                <span class="entry-date"><?php echo esc_html__('On ','suevafree-essential-kit') . get_the_date() . esc_html__(' by ','suevafree-essential-kit') . get_the_author_posts_link(); ?></span>	
