...
Tags: animations, autoplay, ecommerce, product, product carousel, product category, product slider, product slider carousel, product slider categories, rtl, shop, shortcode, slider, woocommerce, e-commerce, woocommerce product slider carousel, woocommerce product carousel, woocommerce slider carousel
...
WIP WooCarousel Lite allows you to create a product carousel for your WooCommerce website.

You can get the premium version, from the following link:

https://www.themeinprogress.com/wip-woocarousel-woocommerce-slider-carousel

== Description ==

Install our WIP WooCarousel Lite, to show a carousel with your WooCommerce products.
Live demo: http://demo.themeinprogress.com/woocarousel/free-version/
...
WIP WooCarousel Lite will add a new admin page, where you can manage the plugin.
...
1. Upload the plugin files to the '/wp-content/plugins/wip-woocarousel-lite' directory, or install the plugin through the WordPress plugins screen directly.
