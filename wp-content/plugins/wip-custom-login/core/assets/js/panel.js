...
/* ===============================================
   ...
   =============================================== */
	...
	$('.WIP_plugin_panel_container .WIP_plugin_panel_box input.upload_button').live("click", function(e) {
...
/* ===============================================
   ...
   =============================================== */
	...
	$('.WIP_plugin_panel_container .wip_mainbox').css({'display':'none'});
	$('.WIP_plugin_panel_container .inactive').next('.wip_mainbox').css({'display':'block'});
	...
	$('.WIP_plugin_panel_container h5.element').live("click", function(){
