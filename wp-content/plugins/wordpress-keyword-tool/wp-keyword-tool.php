...
function wp_keyword_tool_create_meta_box() {
	add_meta_box ( 'wp_keyword_tool-meta-boxes', __('Wordpress Keyword Tool' ,'wp_keyword_tool'), 'wp_keyword_tool_meta_boxes', 'post', 'side', 'high' );
	add_meta_box ( 'wp_keyword_tool-meta-boxes2', __('Keyword Tool Density Check','wp_keyword_tool'), 'wp_keyword_tool_meta_boxes2', 'post', 'side', 'high' );
	
	add_meta_box ( 'wp_keyword_tool-meta-boxes', __('Wordpress Keyword Tool' ,'wp_keyword_tool'), 'wp_keyword_tool_meta_boxes', 'page', 'side', 'high' );
	add_meta_box ( 'wp_keyword_tool-meta-boxes2', __('Keyword Tool Density Check','wp_keyword_tool'), 'wp_keyword_tool_meta_boxes2', 'page', 'side', 'high' );
